...
struct CD3DX12_VIEWPORT : public D3D12_VIEWPORT {
  ...
  explicit CD3DX12_VIEWPORT(_In_ ID3D12Resource *pResource,
                            uint32_t mipSlice = 0, FLOAT topLeftX = 0.0f,
                            FLOAT topLeftY = 0.0f,
...
struct CD3DX12_RASTERIZER_DESC : public D3D12_RASTERIZER_DESC {
  ...
  explicit CD3DX12_RASTERIZER_DESC(
      ...
      BOOL antialiasedLineEnable, uint32_t forcedSampleCount,
...
struct CD3DX12_RESOURCE_ALLOCATION_INFO
  ...
  CD3DX12_RESOURCE_ALLOCATION_INFO(uint64_t size, uint64_t alignment) noexcept {
    SizeInBytes = size;
    Alignment = alignment;
  }
};
...
struct CD3DX12_HEAP_PROPERTIES : public D3D12_HEAP_PROPERTIES {
  ...
  CD3DX12_HEAP_PROPERTIES(D3D12_CPU_PAGE_PROPERTY cpuPageProperty,
                          ...
                          uint32_t creationNodeMask = 1, uint32_t nodeMask = 1)
  noexcept {
...
struct CD3DX12_HEAP_DESC : public D3D12_HEAP_DESC {
  ...
  explicit CD3DX12_HEAP_DESC(const D3D12_HEAP_DESC &o) noexcept
      : D3D12_HEAP_DESC(o) {}
  CD3DX12_HEAP_DESC(uint64_t size, D3D12_HEAP_PROPERTIES properties,
  ...
  CD3DX12_HEAP_DESC(uint64_t size, D3D12_HEAP_TYPE type, uint64_t alignment = 0,
                    D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
  noexcept {
    SizeInBytes = size;
  ...
  CD3DX12_HEAP_DESC(uint64_t size, D3D12_CPU_PAGE_PROPERTY cpuPageProperty,
                    D3D12_MEMORY_POOL memoryPoolPreference,
                    uint64_t alignment = 0,
                    D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
  noexcept {
...
struct CD3DX12_RANGE_UINT64 : public D3D12_RANGE_UINT64 {
  ...
  CD3DX12_RANGE_UINT64(uint64_t begin, uint64_t end) noexcept {
    Begin = begin;
    End = end;
  }
};
...
struct CD3DX12_SUBRESOURCE_RANGE_UINT64
  ...
  CD3DX12_SUBRESOURCE_RANGE_UINT64(uint32_t subresource,
                                   const D3D12_RANGE_UINT64 &range)
  noexcept {
    Subresource = subresource;
    Range = range;
  }
  CD3DX12_SUBRESOURCE_RANGE_UINT64(uint32_t subresource, uint64_t begin,
                                   uint64_t end)
  noexcept {
    Subresource = subresource;
    Range.Begin = begin;
...
struct CD3DX12_TILED_RESOURCE_COORDINATE
  ...
  CD3DX12_TILED_RESOURCE_COORDINATE(uint32_t x, uint32_t y, uint32_t z,
...
struct CD3DX12_TILE_REGION_SIZE : public D3D12_TILE_REGION_SIZE {
  ...
  CD3DX12_TILE_REGION_SIZE(uint32_t numTiles, BOOL useBox, uint32_t width,
...
struct CD3DX12_SUBRESOURCE_TILING : public D3D12_SUBRESOURCE_TILING {
  ...
  CD3DX12_SUBRESOURCE_TILING(uint32_t widthInTiles, UINT16 heightInTiles,
                             UINT16 depthInTiles,
...
struct CD3DX12_TILE_SHAPE : public D3D12_TILE_SHAPE {
  ...
  explicit CD3DX12_TILE_SHAPE(const D3D12_TILE_SHAPE &o) noexcept
      : D3D12_TILE_SHAPE(o) {}
  CD3DX12_TILE_SHAPE(uint32_t widthInTexels, uint32_t heightInTexels,
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT {
  ...
  CD3DX12_SUBRESOURCE_FOOTPRINT(DXGI_FORMAT format, uint32_t width,
...
struct CD3DX12_DESCRIPTOR_RANGE : public D3D12_DESCRIPTOR_RANGE {
  ...
  CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE rangeType,
                           uint32_t numDescriptors, uint32_t baseShaderRegister,
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE : public D3D12_ROOT_DESCRIPTOR_TABLE {
  ...
  inline void
  Init(uint32_t numDescriptorRanges,
       _In_reads_opt_(numDescriptorRanges)
...
struct CD3DX12_ROOT_CONSTANTS : public D3D12_ROOT_CONSTANTS {
  ...
  CD3DX12_ROOT_CONSTANTS(uint32_t num32BitValues, uint32_t shaderRegister,
                         uint32_t registerSpace = 0)
  noexcept {
    Init(num32BitValues, shaderRegister, registerSpace);
  }

  inline void Init(uint32_t num32BitValues, uint32_t shaderRegister,
                   uint32_t registerSpace = 0) noexcept {
    Init(*this, num32BitValues, shaderRegister, registerSpace);
  }

  static inline void Init(_Out_ D3D12_ROOT_CONSTANTS &rootConstants,
                          uint32_t num32BitValues, uint32_t shaderRegister,
                          uint32_t registerSpace = 0) noexcept {
...
struct CD3DX12_ROOT_DESCRIPTOR : public D3D12_ROOT_DESCRIPTOR {
  ...
  CD3DX12_ROOT_DESCRIPTOR(uint32_t shaderRegister, uint32_t registerSpace = 0)
  noexcept {
    Init(shaderRegister, registerSpace);
  }

  inline void Init(uint32_t shaderRegister,
                   uint32_t registerSpace = 0) noexcept {
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER {
  ...
  InitAsConstantBufferView(_Out_ D3D12_ROOT_PARAMETER &rootParam,
                           uint32_t shaderRegister, uint32_t registerSpace = 0,
                           D3D12_SHADER_VISIBILITY visibility =
                               D3D12_SHADER_VISIBILITY_ALL) noexcept {
  ...
  inline void
  InitAsDescriptorTable(uint32_t numDescriptorRanges,
                        _In_reads_(numDescriptorRanges)
                            const D3D12_DESCRIPTOR_RANGE *pDescriptorRanges,
                        D3D12_SHADER_VISIBILITY visibility =
                            D3D12_SHADER_VISIBILITY_ALL) noexcept {
  ...
  inline void InitAsConstants(uint32_t num32BitValues, uint32_t shaderRegister,
                              uint32_t registerSpace = 0,
                              D3D12_SHADER_VISIBILITY visibility =
                                  D3D12_SHADER_VISIBILITY_ALL) noexcept {
  ...
  inline void
  InitAsConstantBufferView(uint32_t shaderRegister, uint32_t registerSpace = 0,
                           D3D12_SHADER_VISIBILITY visibility =
                               D3D12_SHADER_VISIBILITY_ALL) noexcept {
  ...
  inline void
  InitAsShaderResourceView(uint32_t shaderRegister, uint32_t registerSpace = 0,
                           D3D12_SHADER_VISIBILITY visibility =
                               D3D12_SHADER_VISIBILITY_ALL) noexcept {
  ...
  inline void
  InitAsUnorderedAccessView(uint32_t shaderRegister, uint32_t registerSpace = 0,
                            D3D12_SHADER_VISIBILITY visibility =
                                D3D12_SHADER_VISIBILITY_ALL) noexcept {
...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC {
  ...
  CD3DX12_STATIC_SAMPLER_DESC(
      uint32_t shaderRegister, D3D12_FILTER filter = D3D12_FILTER_ANISOTROPIC,
      D3D12_TEXTURE_ADDRESS_MODE addressU = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
      D3D12_TEXTURE_ADDRESS_MODE addressV = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
      D3D12_TEXTURE_ADDRESS_MODE addressW = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
      FLOAT mipLODBias = 0, uint32_t maxAnisotropy = 16,
  ...
  static inline void
  Init(_Out_ D3D12_STATIC_SAMPLER_DESC &samplerDesc, uint32_t shaderRegister,
  ...
  inline void
  Init(uint32_t shaderRegister, D3D12_FILTER filter = D3D12_FILTER_ANISOTROPIC,
       D3D12_TEXTURE_ADDRESS_MODE addressU = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
       D3D12_TEXTURE_ADDRESS_MODE addressV = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
       D3D12_TEXTURE_ADDRESS_MODE addressW = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
       FLOAT mipLODBias = 0, uint32_t maxAnisotropy = 16,
...
struct CD3DX12_ROOT_SIGNATURE_DESC : public D3D12_ROOT_SIGNATURE_DESC {
  ...
  static inline void
  Init(_Out_ D3D12_ROOT_SIGNATURE_DESC &desc, uint32_t numParameters,
       _In_reads_opt_(numParameters) const D3D12_ROOT_PARAMETER *_pParameters,
       uint32_t numStaticSamplers = 0,
       _In_reads_opt_(numStaticSamplers)
           const D3D12_STATIC_SAMPLER_DESC *_pStaticSamplers = nullptr,
...
struct CD3DX12_DESCRIPTOR_RANGE1 : public D3D12_DESCRIPTOR_RANGE1 {
  ...
  CD3DX12_DESCRIPTOR_RANGE1(
      D3D12_DESCRIPTOR_RANGE_TYPE rangeType, uint32_t numDescriptors,
      uint32_t baseShaderRegister, uint32_t registerSpace = 0,
  ...
  inline void
  Init(D3D12_DESCRIPTOR_RANGE_TYPE rangeType, uint32_t numDescriptors,
       uint32_t baseShaderRegister, uint32_t registerSpace = 0,
       D3D12_DESCRIPTOR_RANGE_FLAGS flags = D3D12_DESCRIPTOR_RANGE_FLAG_NONE,
       uint32_t offsetInDescriptorsFromTableStart =
           D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND) noexcept {
...
struct CD3DX12_ROOT_DESCRIPTOR1 : public D3D12_ROOT_DESCRIPTOR1 {
  ...
  inline void Init(uint32_t shaderRegister, uint32_t registerSpace = 0,
...
struct CD3DX12_ROOT_PARAMETER1 : public D3D12_ROOT_PARAMETER1 {
  ...
  static inline void InitAsConstantBufferView(
      _Out_ D3D12_ROOT_PARAMETER1 &rootParam, uint32_t shaderRegister,
      uint32_t registerSpace = 0,
      D3D12_ROOT_DESCRIPTOR_FLAGS flags = D3D12_ROOT_DESCRIPTOR_FLAG_NONE,
      D3D12_SHADER_VISIBILITY visibility =
          D3D12_SHADER_VISIBILITY_ALL) noexcept {
...
struct CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC
  ...
  inline void
  Init_1_0(uint32_t numParameters,
  ...
  static inline void Init_1_0(
      _Out_ D3D12_VERSIONED_ROOT_SIGNATURE_DESC &desc, uint32_t numParameters,
      _In_reads_opt_(numParameters) const D3D12_ROOT_PARAMETER *_pParameters,
      uint32_t numStaticSamplers = 0,
      _In_reads_opt_(numStaticSamplers)
          const D3D12_STATIC_SAMPLER_DESC *_pStaticSamplers = nullptr,
  ...
  inline void
  Init_1_1(uint32_t numParameters,
           _In_reads_opt_(numParameters)
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE {
  ...
  Offset(INT offsetInDescriptors, uint32_t descriptorIncrementSize) noexcept {
  ...
  inline void InitOffsetted(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base,
                            INT offsetInDescriptors,
                            uint32_t descriptorIncrementSize) noexcept {
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE {
  ...
  static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE &handle,
                                   ...
                                   INT offsetInDescriptors,
                                   uint32_t descriptorIncrementSize) noexcept {
    handle.ptr = uint64_t(INT64(base.ptr) + INT64(offsetInDescriptors) *
                                                INT64(descriptorIncrementSize));
  }
};

//------------------------------------------------------------------------------------------------
inline constexpr uint32_t D3D12CalcSubresource(uint32_t MipSlice,
                                               uint32_t ArraySlice,
                                               uint32_t PlaneSlice,
                                               uint32_t MipLevels,
...
inline void D3D12DecomposeSubresource(uint32_t Subresource, uint32_t MipLevels,
                                      uint32_t ArraySize, _Out_ T &MipSlice,
                                      _Out_ U &ArraySlice,
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC {
  ...
  CD3DX12_RESOURCE_DESC(D3D12_RESOURCE_DIMENSION dimension, uint64_t alignment,
                        uint64_t width, uint32_t height,
                        UINT16 depthOrArraySize, UINT16 mipLevels,
                        DXGI_FORMAT format, uint32_t sampleCount,
                        uint32_t sampleQuality, D3D12_TEXTURE_LAYOUT layout,
  ...
  static inline CD3DX12_RESOURCE_DESC
  Buffer(uint64_t width, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE,
  ...
  static inline CD3DX12_RESOURCE_DESC
  Tex1D(DXGI_FORMAT format, uint64_t width, UINT16 arraySize = 1,
        UINT16 mipLevels = 0,
  ...
  static inline CD3DX12_RESOURCE_DESC
  Tex2D(DXGI_FORMAT format, uint64_t width, uint32_t height,
        UINT16 arraySize = 1, UINT16 mipLevels = 0, uint32_t sampleCount = 1,
  ...
  static inline CD3DX12_RESOURCE_DESC
  Tex3D(DXGI_FORMAT format, uint64_t width, uint32_t height, UINT16 depth,
        UINT16 mipLevels = 0,
        D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE,
        D3D12_TEXTURE_LAYOUT layout = D3D12_TEXTURE_LAYOUT_UNKNOWN,
        uint64_t alignment = 0) noexcept {
  ...
  inline uint32_t CalcSubresource(uint32_t MipSlice, uint32_t ArraySlice,
                                  uint32_t PlaneSlice) noexcept {
...
struct CD3DX12_RESOURCE_DESC1 : public D3D12_RESOURCE_DESC1 {
  ...
  CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION dimension, uint64_t alignment,
                         uint64_t width, uint32_t height,
                         UINT16 depthOrArraySize, UINT16 mipLevels,
                         DXGI_FORMAT format, uint32_t sampleCount,
                         uint32_t sampleQuality, D3D12_TEXTURE_LAYOUT layout,
  ...
  Tex2D(DXGI_FORMAT format, uint64_t width, uint32_t height,
        ...
        D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE,
        D3D12_TEXTURE_LAYOUT layout = D3D12_TEXTURE_LAYOUT_UNKNOWN,
        uint64_t alignment = 0, uint32_t samplerFeedbackMipRegionWidth = 0,
        uint32_t samplerFeedbackMipRegionHeight = 0,
...
inline void MemcpySubresource(_In_ const D3D12_MEMCPY_DEST *pDest,
                              ...
                              SIZE_T RowSizeInBytes, uint32_t NumRows,
...
inline uint64_t UpdateSubresources(
    ...
    _In_ ID3D12Resource *pDestinationResource,
    _In_ ID3D12Resource *pIntermediate, uint64_t IntermediateOffset,
    _In_range_(0, D3D12_REQ_SUBRESOURCES) uint32_t FirstSubresource,
    _In_range_(0, D3D12_REQ_SUBRESOURCES - FirstSubresource)
        uint32_t NumSubresources,
    _In_reads_(NumSubresources)
  ...
  uint64_t RequiredSize = 0;
  auto MemToAlloc =
      static_cast<uint64_t>(sizeof(D3D12_PLACED_SUBRESOURCE_FOOTPRINT) +
  ...
  auto pRowSizesInBytes =
      reinterpret_cast<uint64_t *>(pLayouts + NumSubresources);
  auto pNumRows =
      reinterpret_cast<uint32_t *>(pRowSizesInBytes + NumSubresources);
...
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
    uint32_t, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_NODE_MASK>
...
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
    uint32_t, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_SAMPLE_MASK,
    DefaultSampleMask>
...
struct CD3DX12_PIPELINE_STATE_STREAM2_PARSE_HELPER
  ...
  void NodeMaskCb(uint32_t NodeMask) override {
  ...
  void SampleMaskCb(uint32_t SampleMask) override {
...
public:
  ...
  void Config(uint32_t MaxPayloadSizeInBytes,
              uint32_t MaxAttributeSizeInBytes) noexcept {
...
public:
  ...
  void SetNodeMask(uint32_t NodeMask) noexcept { m_Desc.NodeMask = NodeMask; }
  D3D12_STATE_SUBOBJECT_TYPE Type() const noexcept override {
